...
public class EventMapper {
    ...
    public static Event toEvent(EventFullDto eventFullDto, User user, EventState state) {
        return Event.builder()
                ...
                .createdOn(LocalDateTime.parse(eventFullDto.getCreatedOn(), DATE))
                .description(eventFullDto.getDescription())
                .eventDate(LocalDateTime.parse(eventFullDto.getEventDate(), DATE))
                .initiator(user)
                .location(eventFullDto.getLocation())
                .paid(eventFullDto.getPaid())
                .participantLimit(eventFullDto.getParticipantLimit())
                .publishedOn(LocalDateTime.parse(eventFullDto.getPublishedOn(),DATE))
    ...
    public static Event toEvent(NewEventDto newEventDto, User user, Category category) {
        return Event.builder()
                ...
                .eventDate(LocalDateTime.parse(newEventDto.getEventDate(), DATE))
        ...
        public static EventFullDto toEventFullDto(Event event) {
            return EventFullDto.builder()
                    ...
                    .createdOn(LocalDateTime.now().format(DATE))
                    ...
                    .publishedOn(event.getPublishedOn() == null ? "" : event.getPublishedOn().format(DATE))
    ...
    public static EventFullDto toUpdateEventAdminRequest(UpdateEventAdminRequest updateEventAdminRequest, Event event, CategoryDto categoryDto) {
        return EventFullDto.builder()
                ...
                .eventDate(updateEventAdminRequest.getEventDate() != null ? updateEventAdminRequest.getEventDate() : (DATE.format(event.getEventDate())))
                ...
                .confirmedRequests(event.getConfirmedRequests())
                .createdOn(DATE.format(event.getCreatedOn()))
                .initiator(UserMapper.toUserShortDto(event.getInitiator()))
                .publishedOn(DATE.format(event.getPublishedOn()))
                .views(event.getViews())
                .build();
    }
